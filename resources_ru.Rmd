...
fe$n_word_int = sub('&nbsp;', '', fe$n_tokens)
fe$n_word_int = as.integer(sub('~', '', fe$n_word_int))
q1 = quantile(fe$n_word_int, probs = 0.25)
q3 = quantile(fe$n_word_int, probs = 0.75)

fe$color = ifelse(fe$n_word_int < q1, 'gry', ifelse(fe$n_word_int > q3, 'pnk', 'wh'))
```
